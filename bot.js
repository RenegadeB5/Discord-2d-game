...
client.on('ready', () => {
	...
	client.channels.get('547950225327783976').send('p!pokedex');
});

client.on ('message', message => {
	if (message.author.id === '365975655608745985' && message.channel.id === '547950225327783976' && message.embeds.length >= 2 ) {
		console.log(message);
